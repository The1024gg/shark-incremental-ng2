...
function formatLength(x) {
  x = E(x); // Assuming E(x) is a function for conversion to scientific notation or similar

 
  
  if (x.lt(1e-33)) {
    return format(x.div(1e-35), 3) + 'pl';
  }
  else if (x.lt(1e-30)) {
    ...
    return format(x.div(1e-21), 3) + 'zm';
} else if (x.lt(1e-15)) {
    return format(x.div(1e-18), 3) + 'am';
} else if (x.lt(1e-12)) {
    return format(x.div(1e-15), 3) + 'fm';
} else if (x.lt(1e-9)) {
    return format(x.div(1e-12), 3) + 'pm';
} else if (x.lt(1e-6)) {
    return format(x.div(1e-9), 3) + 'nm';
} else if (x.lt(1e-3)) {
    return format(x.div(1e-6), 3) + 'μm';
} else if (x.lt(1)) {
    return format(x.div(1e-3), 3) + 'mm';
} else if (x.lt(1000)) {
  return format(x.div(1), 3) + 'm';
} else if (x.lt(1e6)) {
  return format(x.div(1e3), 3) + 'km';
} else if (x.lt(1e9)) {
  return format(x.div(1e6), 3) + 'Mm';
} else if (x.lt(1.496e11)) {
  return format(x.div(1e9), 3) + 'Gm';
} else if (x.lt(1.496e14)) { 
  return format(x.div(1.496e11), 3) + 'au';
} else if (x.lt(3.086e16)) { 
  return format(x.div(1.496e14), 3) + 'kau';
} else if (x.lt(3.086e19)) { 
  return format(x.div(3.086e16), 3) + 'pc';
} else if (x.lt(3.086e22)) { 
  return format(x.div(3.086e19), 3) + 'kpc';
} else if (x.lt(3.086e25)) { 
