...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'universe-name': "Universes",
        'universe-costName': toTextStyle('Universes','universe'),

        'antimatter-name': "Antimatter",
        'antimatter-costName': toTextStyle('Antimatter','universe'),
        ...
        'curr-top-6-reset': (x,next) => `Big Bang for <b>${format(x,0)}</b> ${toTextStyle('Universes', 'universe')} (Next at <b>${format(next)}</b> ${toTextStyle('Fish','fish')})`,
        ...
        'tab-universe-milestones': toTextStyle('Universe','universe') + " Milestones",
        'tab-rocket-exploration': "Rocket Exploration",
        'tab-quarks': "Quarks",
        ...
        'universe-size-div': (x, y) => `The size of your ${toTextStyle('Universe','universe')} is <h3>${x}</h3>, boosting the exponent of ${toTextStyle('Fish','fish')} by <h3>${y}</h3>`,

        'antimatter-div': (x,y) => `You have <h3>${x}</h3> ${toTextStyle('Antimatter','universe')}, boosting ${toTextStyle('Universe','universe')} size gain by <h3>${y}</h3>`,

        'rocket-tier-div': x => `Your Rocket Tier is <h3>${x}</h3>.`,
        'rocket-tier-upgrade': x => `Upgrade your rocket tier for <b>${x}</b> rocket parts`,
        'rocket-explored': (x,y) => `You have explored <h3>${x}</h3> (${y}/s) of the outer universe.`,
        ...
        'forge': {
            ...
            'antimatter': ['Antimatter Booster',`Increases ${toTextStyle('Antimatter', 'universe')} gain.`],
        },
        ...
        'constellation-boosts': [
            ...
            [`Stellar Matter`, x=>`Boost the exponent of ${toTextStyle('Dark Matter','black-hole')} by ${x}.`, x=>`Stellar matter does not do anything in the solar system. I am sorry, but it simply does not do anything, you are a disappointment, you are the reason why our father left us, you emotionally scarred me for the rest of my life, I simply cannot look at you the same anymore, farewell brother...`],
        
        ],
        //universe
        get 'universe-milestones'() {
            return [
                [`0.1pl of ${toTextStyle('Universe', 'universe')} size`,`Unlock ${toTextStyle('Antimatter', 'universe')} generation.`],
                [`10pl of ${toTextStyle('Universe', 'universe')} size`,`${toTextStyle('Universe', 'universe')} size boosts the exponent of ${toTextStyle('Fish','fish')}, also boost the effect of ${toTextStyle('Antimatter', 'universe')}.`],
                [`100mcm of ${toTextStyle('Universe', 'universe')} size`,`Unlock a new <b>Forge</b> upgrade.`],
                [`1pm of ${toTextStyle('Universe', 'universe')} size`,`${toTextStyle("Constellation",'star')} resources are boosted, ${toTextStyle('Antimatter', 'universe')} gain is boosted.`],
                [`100Mm of ${toTextStyle('Universe', 'universe')} size`,`The Black Hole Tier's scaling is delayed by <b>+10</b>.`],
                [`10kpc of ${toTextStyle('Universe', 'universe')} size`,`${toTextStyle('Antimatter', 'universe')} effect is boosted again.`],
                [`${formatLength(1e79)} of ${toTextStyle('Universe', 'universe')} size`,`Unlock the next ${toTextStyle('Universe', 'universe')} feature, and boost ${toTextStyle('Dark Matter','black-hole')}.`],
        ...
        get 'rocket-milestones'() {
            return [
                [`2.5km explored`,`Delay the ${toTextStyle('Fish','fish')} hardcap by log(universe explored)^2.`],
                [`10km explored`,`Start gaining more exploration based off your Rocket Tier.`],
                [`100km explored`,`Delay the Black Hole Tier's scaling by <b>+25</b>, and raise the ${toTextStyle("Constellation",'star')} xp by <b>${formatPow(1.5)}</b>.`],
                [`500km explored`,`Boost ${toTextStyle('Antimatter', 'universe')} gain by log(universe explored)^0.25.`],
                [`1Gm explored`,`Delay ${toTextStyle("Remnant",'black-hole')} upgrade scalings.`],
                [`2.5Gm explored`,`Boost the exponent of ${toTextStyle('Dark Matter','black-hole')} by <b>${formatPow(1.5)}</b>.`],
                [`1kau explored`,`Boost the exponent of ${toTextStyle('Fish','fish')} by <b>${formatPow(69420)}</b>`],
                [`10kau explored`,`Boost the ${toTextStyle("Constellation",'star')} exponent by <b>${formatMult(5)}</b>.`],
                ]
        },
        ...
        get 'progress-20-cond-text'() { return `Do a ${toTextStyle('Big Bang','Universe')}` },
        ...
        get 'reset-sacrifice-message'() {
            ...
            `
        }, get 'reset-universe-message'() {
            let e = toTextStyle('Sacrifice','black-hole'), u = toTextStyle('Big Bang','universe'), p = toTextStyle('Universe','universe'), f = toTextStyle('Fish','fish')
            return `
            <h3>The ${u}</h3><br>
            <subtitle>“Thanks to garoot for the art!”</subtitle>
            The ${u} is the fifth major reset layer.
            Doing the ${u} resets everything the ${e} does, although you wont lose your ${toTextStyle('Singularity', 'black-hole')} progress, for a new ${p}, raising the ${f} hardcap. <br>
            <img src="textures/universe.png"><br>
            Are you sure you want to go ${u}?
            `
        },
